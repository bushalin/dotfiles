return {
  {
    ...
    keys = {
      ...
      { "<localleader>rf", mode = "o",               function() require("flash").remote() end,            desc = "Remote Flash" },
      { "<localleader>R",  mode = { "o", "x" },      function() require("flash").treesitter_search() end, desc = "Treesitter Search" },
      { "<localleader>tf", mode = { "c" },           function() require("flash").toggle() end,            desc = "Toggle Flash Search" },
    },
  },
}
